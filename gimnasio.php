...
class Entrenador extends Persona{
    ...
    public function asignarClase($clases){
        $this -> aClases [] = $clases;
    }
...
$alumno2->presentismo = 68;
 $alumno3 = new Alumno("39765454", "Facundo Fagnano", "facundo@mail.com", "1145632457",
"1993-02-06");
$alumno3->setFichaMedica(90, 187, true);
$alumno3->presentismo = 88;
 $alumno4 = new Alumno("11687536", "Gastón Aguilar", "gaston@mail.com", "1145632457", "1999-11-02");
